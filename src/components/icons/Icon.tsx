...
export type IconName =
  ...
  // Status
  | 'completed' | 'failed' | 'skipped' | 'circle-dash' | 'sun' | 'moon'
  // Activity Status
...
const SVGIcons: Record<string, React.ComponentType<{ size: number; color: string }>> = {
  ...
  sun: ({ size, color }) => (
    <Svg width={size} height={size} viewBox="0 0 128 128" fill={color}>
      <Circle cx="64" cy="64" r="29.85"/>
      <Path d="M57.89,117.92L60.38,101.48L67.81,101.36L70.81,117.72L57.89,117.92Z"/>
      <Path d="M21.55,97.81L34.94,87.94L40.27,93.11L30.83,106.8L21.55,97.81Z"/>
      <Path d="M10.08,57.89L26.52,60.38L26.64,67.81L10.28,70.81L10.08,57.89Z"/>
      <Path d="M30.19,21.55L40.06,34.94L34.89,40.27L21.2,30.83L30.19,21.55Z"/>
      <Path d="M70.11,10.08L67.62,26.52L60.19,26.64L57.19,10.28L70.11,10.08Z"/>
      <Path d="M106.45,30.19L93.06,40.06L87.73,34.89L97.17,21.2L106.45,30.19Z"/>
      <Path d="M117.92,70.11L101.48,67.62L101.36,60.19L117.72,57.19L117.92,70.11Z"/>
      <Path d="M97.81,106.45L87.94,93.06L93.11,87.73L106.8,97.17L97.81,106.45Z"/>
    </Svg>
  ),

  moon: ({ size, color }) => (
    <Svg width={size} height={size} viewBox="0 0 128 128" fill={color}>
      <Path d="M109.06,64c0,24.89-20.17,45.06-45.06,45.06-22.37,0-40.93-16.29-44.46-37.65,6.73,7.53,16.53,12.27,27.43,12.27,20.32,0,36.8-16.48,36.8-36.8,0-10.83-4.68-20.57-12.12-27.3,21.25,3.63,37.41,22.14,37.41,44.42Z"/>
    </Svg>
  ),
